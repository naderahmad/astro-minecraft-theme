...
import { logo } from "astrocraft:assets"
import gif from '../../assets/blocks.gif'

<div class="flex flex-col items-center justify-center gap-20 py-16 h-full">
  <div class="flex items-center justify-center">
    <div class="flex flex-col items-center justify-center text-center gap-8">
      <div class="relative -mb-8">
        <Image src={logo} alt="logo" />
        <span class="-rotate-12 absolute bottom-1/4 right-0 animate-pulse text-minecraft-yellow text-lg">Using UnoCSS</span>
      </div>
      ...
      <ul class="flex items-center gap-4">
        <li><a href="reference" class="minecraft-button p-4 text-xl">Get Started!</a></li>
    ...
    <div class="hidden md:flex items-center justify-center mt-12 p-2">
      <Image src={gif} alt="Animated minecraft blocks showcase" quality={100} class="scale-90"/>
    </div>
  </div>
